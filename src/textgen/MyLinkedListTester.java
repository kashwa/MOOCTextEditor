...
public class MyLinkedListTester {
	...
	public void testAddEnd()
	{
        ...
        state = addList.add(2);
        assertEquals("check state correct", true, state);
        assertEquals("check value is correct", (Integer)2, addList.get(2));
        assertEquals("check size is correct", 3, addList.size());
	}
	...
	{
		assertEquals("Size: addList ", 1, addList.size());
